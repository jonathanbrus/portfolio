...
export const About: React.FC = () => {
  return (
    <Box component="div" id="about" sx={{ backgroundColor: "primary.dark" }}>
      ...
      >
        <Box
          sx={{ flex: 1, display: "flex", alignItems: "center", justifyContent: { xs: "center", md: "flex-start" } }}
        >
          <Box
            component="img"
        ...
        <Box sx={{ flex: 1.3 }}>
          ...
          <Typography sx={{ my: "0.3rem", fontSize: { xs: "2.2rem", sm: "2.8rem" }, fontWeight: "bold" }}>
            A Bit About Me
          </Typography>
          <Typography variant="body1" sx={{ my: "0.8rem" }}>
            ...
            matters to me. I'm a self-taught and always stay updated with the technologies I use to build softwares and
            deliver the best.
          </Typography>
